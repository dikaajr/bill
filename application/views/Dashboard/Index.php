...
<div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">559</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-green">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Lagu RBT</span>
              <span class="info-box-number">9.431</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Transaksi Pencairan Pendapatan RBT</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-red">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Pendapatan dari Operator</span>
              <span class="info-box-number">Rp. 875.000.000,-</span>
