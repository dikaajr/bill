<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "c_transaksi/json", "type": "POST"},
                    columns: [
                         {
                            "data": "id_transaksi",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "id_transaksi",
                            "orderable": false
                        },{"data": "judul"},{"data": "revenue"},{"data": "month"},{"data": "username"},{"data": "tgl_dibuat"},{"data": "tgl_disetujui"},{"data": "status"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
