    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?= $button;?> T_partner</h3>
	    ...
	    <div class="form-group">
            <label for="varchar">NamaPartner <?php echo form_error('namaPartner') ?></label>
            <input type="text" class="form-control" name="namaPartner" id="namaPartner" placeholder="NamaPartner" value="<?php echo $namaPartner; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <input type="hidden" name="id_partner" value="<?php echo $id_partner; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('c_partner') ?>" class="btn btn-default">Cancel</a>
	</form>
         </div>
        </div>
    </div>
